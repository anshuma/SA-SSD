...
data_root = '/u/student/2021/cs21resch15003/cs21mds14030/mca/SA-SSD/data/'
img_norm_cfg = dict(
...
# optimizer
optimizer = dict(
    type='sgd', lr=0.003 ,momentum=0, weight_decay=0.01,
...
log_level = 'INFO'
work_dir = '/u/student/2021/cs21resch15003/cs21mds14030/mca/SA-SSD/checkpoint_10Apr_SGD'
load_from = None
resume_from = None
workflow = [('train', 1)]
